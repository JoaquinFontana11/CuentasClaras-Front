...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 ">
      ...
      <form class="space-y-4 md:space-y-6" (ngSubmit)="editarGrupo()" #groupEditForm="ngForm">
        <!-- Campos de edición -->
        <div>
        ...
        <button type="submit" [hidden]="groupEditForm.invalid" class="text-white bg-blue-500 px-4 py-2 rounded hover:bg-blue-700 mt-auto">
          Guardar cambios
        </button>
      </form>
      </div>
