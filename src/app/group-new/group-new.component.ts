...
@Component({
  ...
  template: `
    ...
    <!-- ... -->
    <div>
      <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><span class="text-red-500">(**)</span> Nombre</label>
      <input
        type="text"
        name="nombre"
        id="nombre"
    ...
    <div>
      <label for="categoria" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><span class="text-red-500">(**)</span> Categoría</label>
      <select
        [(ngModel)]="cat"
        name="categoria"
        id="categoria"
